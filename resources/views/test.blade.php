...
<body>
    ...
    <div id="services" class="our-services section">
        <div class="services-right-dec">
            <img src="{{ url('/') }}/assets/images/services-right-dec.png" alt="">
        </div>
        <div class="container">
            <div class="services-left-dec">
                <img src="{{ url('/') }}/assets/images/services-left-dec.png" alt="">
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="owl-carousel owl-services">
                        <div class="item">
                            ...
                            <div class="icon"><img src="{{ url('/') }}/assets/images/service-icon-01.png" alt="">
                            </div>
                            <p>Feel free to use this template for your business</p>
                        </div>
                        <div class="item">
                            <h4>Develop The Best Strategy for Business</h4>
                            <div class="icon"><img src="{{ url('/') }}/assets/images/service-icon-02.png" alt="">
                            </div>
                            <p>Get to know more about the topic in details</p>
                        </div>
                        <div class="item">
                            <h4>UI / UX Design and Development</h4>
                            <div class="icon"><img src="{{ url('/') }}/assets/images/service-icon-03.png" alt="">
                            </div>
                            <p>Get to know more about the topic in details</p>
                        </div>
                        <div class="item">
                            <h4>Discover &amp; Explore our SEO Tips</h4>
                            <div class="icon"><img src="{{ url('/') }}/assets/images/service-icon-04.png" alt="">
                            </div>
                            <p>Feel free to use this template for your business</p>
                        </div>
                        <div class="item">
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-image">
                        <img src="{{ url('/') }}/assets/images/about-left-image.png"
    ...
    <div id="portfolio" class="our-portfolio section">
        <div class="portfolio-left-dec">
            <img src="{{ url('/') }}/assets/images/portfolio-left-dec.png" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-carousel owl-portfolio">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ url('/') }}/assets/images/portfolio-01.jpg" alt="">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ url('/') }}/assets/images/portfolio-02.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        <a href="#">
                                            <h4>Project Two</h4>
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ url('/') }}/assets/images/portfolio-03.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="inner-content">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ url('/') }}/assets/images/portfolio-04.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        <a href="#">
                                            <h4>Project Four</h4>
    ...
    <div id="pricing" class="pricing-tables">
        <div class="tables-left-dec">
            <img src="{{ url('/') }}/assets/images/tables-left-dec.png" alt="">
        </div>
        <div class="tables-right-dec">
            <img src="{{ url('/') }}/assets/images/tables-right-dec.png" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
    ...
    <div id="video" class="our-videos section">
        <div class="videos-left-dec">
            <img src="{{ url('/') }}/assets/images/videos-left-dec.png" alt="">
        </div>
        <div class="videos-right-dec">
            <img src="{{ url('/') }}/assets/images/videos-right-dec.png" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="menu">
                                        <div class="active">
                                            <div class="thumb">
                                                <img src="{{ url('/') }}/assets/images/video-thumb-01.png" alt="">
                                                <div class="inner-content">
                                                    <h4>Project One</h4>
                                                    <span>SEO &amp; Marketing</span>
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumb">
                                                <img src="{{ url('/') }}/assets/images/video-thumb-02.png" alt="">
                                                <div class="inner-content">
                                                    <h4>Second Project</h4>
                                                    <span>Advertising &amp; Marketing</span>
                                                </div>
                                        ...
                                        <div>
                                            <div class="thumb">
                                                <img src="{{ url('/') }}/assets/images/video-thumb-03.png"
                                                    alt="Marketing">
                                                <div class="inner-content">
                                                    <h4>Project Three</h4>
                                                    <span>Digital &amp; Marketing</span>
                                        ...
                                        <div>
                                            <div class="thumb">
                                                <img src="{{ url('/') }}/assets/images/video-thumb-04.png"
                                                    alt="SEO Work">
                                                <div class="inner-content">
                                                    <h4>Fourth Project</h4>
                                                    <span>SEO &amp; Advertising</span>
